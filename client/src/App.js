...
import { darkTheme, lightTheme } from "./styles/darkMode.styled";
// import CompetitionApi from './DevelopmentLocal/CompetitionApi';

const App = () => {
  //Dark theme state and function to toggle dark theme
    ...
    <ThemeProvider theme={theme === "light" ? lightTheme : darkTheme}>
      <div>
        ...
        <Routes>
          ...
          <Route
            path="/"
            element={<LandingPage2 themeToggler={themeToggler} theme={theme} />}
          />
          ...
          <Route
            path="/add-content-core-only"
            element={<AddContentCoreOnly />}
          />
