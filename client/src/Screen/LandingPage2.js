...
import { darkTheme } from "../styles/darkMode.styled";

const LandingPage2 = ({ themeToggler, theme }) => {
      ...
      <Container theme={theme}>
        <Navbar theme={theme}>
          ...
          <div className="menu-list">
            <a href="/blogs/all" className="item">
              All Blogs
            </a>
            ...
            <a href="/coding-competitions" className="item">
              Competitions
            </a>
          ...
          <div className="responsive-1700">
            <div className="left">
              ...
              <Fade>
                <div className="small-desc">
                  Algolisted is a community-driven platform for learning and
                  improving coding skills. It offers a wealth of information on
                  data structures and algorithms, and allows coders to interact
                  with, modify, and contribute to the content.
                </div>
              </Fade>
              <Fade left>
                <div className="learn">
            ...
            <div className="right">
              <Fade>
                <div className="img-container">
                  <img
                    src="https://assets.website-files.com/624ac40503a5277051af4162/6346dab74a46df9125bf12bf_Speed%20up%20your%20annotation%20work%20with%20the%20help%20of%20AI.gif"
                    alt=""
                    draggable="false"
                  />
                </div>
            ...
            <div className="left">
              <div className="left-content">
                ...
                <div className="points">
                  ...
                  <RouterLink
                    to="organisation-information/core-team"
                    className="link"
                  >
                    Team
                  </RouterLink>
                  <RouterLink
                    to="organisation-information/mission"
                    className="link"
                  >
                    Our Mission
                  </RouterLink>
                  <RouterLink
                    to="organisation-information/contact"
                    className="link"
                  >
                    Contact
                  </RouterLink>
                  <RouterLink
                    to="organisation-information/future-vision"
                    className="link"
                  >
                    Future Vision
                  </RouterLink>
...
const Container = styled.div`
  ...
  background-color: ${(theme) =>
    theme.theme === "dark" ? darkTheme.colors.landingPage.background : "white"};
  /* background-color: pink; */
  margin: 0;
    ...
    .responsive-1700 {
      ...
      .heading {
        h1 {
          color: ${(theme) =>
            theme.theme === "dark"
              ? darkTheme.colors.landingPage.text
              : "black"};
          font-size: 65px;
          font-weight: 400;
        }
      ...
      .small-desc {
        color: ${(theme) =>
          theme.theme === "dark" ? darkTheme.colors.landingPage.text : "black"};
        font-size: 1.15rem;
        font-weight: 200;
        margin: 30px 0;
        line-height: 2.25rem;
  ...
  .page2 {
    ...
    background-color: ${(theme) =>
      theme.theme === "dark"
        ? darkTheme.colors.landingPage.background
        : "#fbf5ff"};
    border-bottom: 1px solid #fee0e0;
...
const Navbar = styled.div`
  ...
  background-color: ${(theme) =>
    theme.theme === "dark"
      ? darkTheme.colors.landingPage.background
      : "#ffffffd4"};
  // background-color: ${darkTheme.colors.landingPage.background};
...
const PageThreeFooter = styled.div`
  ...
  background-color: ${(theme) =>
    theme.theme === "dark"
      ? darkTheme.colors.landingPage.backgroundTwo
      : "#052744"};
  padding-top: 36px;
  position: relative;
  ...
  .top {
    ...
    input {
      padding: 15px;
      background-color: ${(theme) =>
        theme.theme === "dark" ? darkTheme.colors.landingPage.text : "#031b2f"};
      outline: none;
      width: 400px;
      color: ${(theme) =>
        theme.theme === "dark"
