          ...
          <div className="text">The is website is under constant development, if there is something you can contribute the website with <a href="/"> click here</a>.</div>
                ...
                <div className="main-page">
                    ...
                    <div className="sub-content">
                        ...
                        <div className="btns">
                            <div onClick={() => setShowModel(true)} className="btn">Non-Techincal Content Writer</div>
                            <div onClick={() => setShowModel(true)} className="btn">Social Media Posts Maker</div>
                            <div onClick={() => setShowModel(true)} className="btn">Documentation Management</div>
                            <div onClick={() => setShowModel(true)} className="btn">Product Management</div>
                            <div onClick={() => setShowModel(true)} className="btn">Resources Provider</div>
                        </div>
                    </div>
                    ...
                    <div className="sub-content">
                        ...
                        <div className="btns">
                            <div onClick={() => setShowModel(true)} className="btn">Technical Content Writer</div>
                            <div onClick={() => setShowModel(true)} className="btn">SEO - Search Engine Optimisation</div>
                            <div onClick={() => setShowModel(true)} className="btn">React Style Component - CSS</div>
                            <div onClick={() => setShowModel(true)} className="btn">React JS</div>
                            <div onClick={() => setShowModel(true)} className="btn">Node JS</div>
                            <div onClick={() => setShowModel(true)} className="btn">Blockchain</div>
                            <div onClick={() => setShowModel(true)} className="btn">Machine Learning</div>
                        </div>
                    </div>
                </div>
                {
                    showModel ? (
                        <Model>
                            <div className="content-box">
                                <div className="top-banner"><h1>Algorithmist.</h1></div>
                                <div className="flex-column">
                                    <div className="desc">Lorem ipsum dolor sit, <b>Technical Content Writer</b> amet consectetur adipisicing elit. Pariatur voluptatum, expedita ullam quas qui ratione consequuntur minus, quod culpa itaque doloremque voluptas, placeat dolore laboriosam perspiciatis nisi fugit? Blanditiis, voluptatem.</div>
                                    <textarea className='text-area-input' placeholder='Enter about your skills or give your portfolio . . .'></textarea>
                                    <div className="submit-btn">Submit</div>
                                </div>
                            </div>
                            <div className="close-btn" onClick={() => setShowModel(false)}><ClearIcon/></div>
                        </Model>
                    ):(<></>)
                }
            </Container>
