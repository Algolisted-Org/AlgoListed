    ...
    <GrandContainer>
      ...
      <Container>
        ...
        <div className="top-page">
          <div className="responsive-1700">
            <div className="left">
              ...
              <div className="small-desc">This text needs to be changed. Better data leads to more performant models. Performant models lead to faster deployment. Deliver value from your AI investments faster with better data.</div>
        ...
        <div className="categories-page">
          ...
          <section>
            <div className="sub-page-head">2. All Coding Competitions</div>
            <div className="sub-page-sub-head">Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum facere perferendis eos voluptates nisi incidunt sint dolores rem blanditiis vero!</div>
            <div className="cat-boxes">
          ...
          <section>
            <div className="sub-page-head">3. All Off-Campus Opportunities</div>
